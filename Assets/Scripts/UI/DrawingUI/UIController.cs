...
public class UIController : MonoBehaviour
{
    ...
    private VisualElement m_canvas, m_canvasBackground, m_previewCanvas;
    private VisualElement m_clearButton, m_eraserButton, m_brushButton, m_lineButton, m_squareButton, m_colorPickerButton;
    ...
    private VisualElement m_brushSizeLabel, m_brushSizePlusButton, m_brushSizeMinusButton, m_saveButton;
    ...
    private void Awake()
    {
        ...
        m_eraserButton = m_uiDocument.rootVisualElement.Q<VisualElement>("EraserButton");
        ...
        m_saveButton = m_uiDocument.rootVisualElement.Q<VisualElement>("SaveButton");
    ...
    private void Start()
    {
        ...
        m_toolButtons.Add(m_eraserButton);
        ...
        m_eraserButton.RegisterCallback<ClickEvent>((arg) => OnEraserClicked?.Invoke());
        m_eraserButton.RegisterCallback<ClickEvent>((evt) => SetButtonChecked(evt, m_eraserButton));
        ...
        m_saveButton.RegisterCallback<ClickEvent>((arg) => OnSaveButtonClicked?.Invoke());
